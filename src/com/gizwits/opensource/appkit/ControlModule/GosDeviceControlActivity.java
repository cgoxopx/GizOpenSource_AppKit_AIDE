...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Spinner sp_enum_LED_Color;
	...
	private void initView() {
		...
		sp_enum_LED_Color = (Spinner) findViewById(R.id.sp_enum_LED_Color);
	...
	private void initEvent() {
		...
		sp_enum_LED_Color.setSelection(0, false);
		sp_enum_LED_Color.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != LED_Color) {
	...
	protected void updateUI() {
		...
		sp_enum_LED_Color.setSelection(LED_Color, true);
		...
		tv_data_Motor_Speed.setText(Motor_Speed+"");
		sb_data_Motor_Speed.setProgress((int)((Motor_Speed - MOTOR_SPEED_ADDITION) / MOTOR_SPEED_RATIO - MOTOR_SPEED_OFFSET));
